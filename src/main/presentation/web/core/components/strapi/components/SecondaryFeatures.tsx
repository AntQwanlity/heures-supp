...
export type SecondaryFeatureIcon = "reporting" | "list" | "contact";

const Icons: Record<SecondaryFeatureIcon, React.ReactNode> = {
  reporting: (
    <>
      <defs>
        <linearGradient
...
const Feature: React.FC<FeatureProps> = ({ feature, isActive, className, ...props }) => {
  return (
...
const FeaturesMobile: React.FC<{ features: SecondaryFeature[] }> = ({ features }) => {
  return (
...
const FeaturesDesktop: React.FC<{ features: SecondaryFeature[] }> = ({ features }) => {
  return (
    <Tab.Group as="div" className="hidden lg:mt-20 lg:block">
      {({ selectedIndex }) => (
        <>
          ...
          <div className="relative mt-20 overflow-hidden"></div>
...
export const SecondaryFeatures: React.FC<Props> = ({ title, subtitle, features }) => {
  return (
